<img src="https://github.com/Supernova-Studio/exporter-flutter-svg-assets/blob/main/readme-icon.png?raw=true" alt="Supernova Logo" style="max-width:100%;">
...
The Flutter SVG exporter allows you to **produce flutter asset packs** in such a way that it can be immediately used in your production codebase. Specifically, this exporter is capable of exporting full asset resource directory as usable vectors.
...
In order to make the Supernova Flutter SVG Asset exporter available for your organization so you can start generating code from your design system, please follow the installation guide in our [developer documentation](https://developers.supernova.io/using-exporters/installing-exporters).
